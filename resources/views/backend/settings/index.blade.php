                ...
                <tbody id="sortable">
                    ...
                    <tr id="item-{{$adminSettings->id}}">
                        ...
                        <td>
                            ...
                            <img width="50" src="/images/settings/{{$adminSettings['settings_value']}}" alt="">
                            @else
...
<script type="text/javascript">
    ...
    $(".fa-trash-o").click(function() {
        destro_id = $(this).attr('id');

        alertify.confirm('Silme İşlemimini Onaylıyormusunuz', 'Bu işlem Geri Alınamaz',
            function() {
                location.href = "/admin/settings/delete/" + destro_id;
            },
            function() {
