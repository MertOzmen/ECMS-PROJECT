  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="{{route('admin.index')}}" class="logo">
        ...
        <span class="logo-mini"><b>Sev</b>eSa</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Sev</b>eSa</span>
      </a>
    ...
    <aside class="main-sidebar">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li><a href="{{route('admin.index')}}"><i class="fa fa-link"></i> <span>Anasyfa</span></a></li>
    ...
    <footer class="main-footer">
      ...
      <!-- Default to the left -->
      <strong>Copyright &copy; 2016 <a href="#">SEVESA</a>.</strong> All rights reserved.
    </footer>
